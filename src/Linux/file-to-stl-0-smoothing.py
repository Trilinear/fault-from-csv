# This file is basically the same as the normal file-to-stl.py but instead, the conversion from a
# .dat file to a .ts file runs on zero smoothing parameter compared to the default.
...
def writeTS(file):
    ...
    command = f"python3 ./Meshing/creating_geometric_models/create_fault_from_trace.py {args.location + file} 0 90 --dd 0.5e3 --maxdepth 2.5e4 --extend 4e3 --smoothingParameter 0"
